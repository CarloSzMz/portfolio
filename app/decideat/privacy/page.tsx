...
export const metadata: Metadata = {
  title: "Privacy Policy - DecidEat",
  description: "Privacy policy for DecidEat mobile application",
  robots: {
    index: true,
    follow: true,
  },
    ...
    <div className="min-h-screen bg-background">
      <div className="container max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <p>
            This privacy policy applies to the DecidEat app (hereby referred to as "Application") for mobile devices
            that was created by calosanz (hereby referred to as "Service Provider") as a Free service.
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>
              <strong>Third-Party Services:</strong> Periodically, the Service Provider may transmit anonymized location data
              to external services. These services assist them in enhancing the Application and optimizing their offerings.
            </li>
          </ul>
          ...
          <p>
            ...
            certain personally identifiable information, including but not limited to email, location. The information that
          ...
          <p>
            ...
            them at{" "}
            <a href="mailto:carlosanzmunoz@gmail.com" className="text-primary hover:underline">
          ...
          <p className="font-semibold">This privacy policy is effective as of 2025-11-20</p>
